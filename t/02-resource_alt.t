...
$r = dancer_response(GET => '/user/create.json', { params => {name => 'Foo' }});
...
$r = dancer_response(GET => '/user/1/update.json', { 
    params => {
        nick => 'foobar', 
        name => 'Foo Bar' 
    }
...
$r = dancer_response(GET => '/user/create', { 
    params => {
        name => 'John Doe' 
    }
});
